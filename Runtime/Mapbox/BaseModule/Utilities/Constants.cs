...
namespace Mapbox.BaseModule.Utilities
{
	...
	{
		public const string SDK_VERSION = "3.0.7";
		...
		public static class Path
		{
			...
			public const string IOS_MAPBOXCOMMON_XCFRAMEWORK_SOURCE_RELATIVEPATH = "Mapbox/BaseModule/Plugins/iOS/MapboxCommon.xcframework";
			public const string IOS_MAPBOXCOMMON_XCFRAMEWORK_DESTINATION_RELATIVEPATH = "Frameworks/MapboxCommon/Plugins/iOS/MapboxCommon.xcframework";
		}
